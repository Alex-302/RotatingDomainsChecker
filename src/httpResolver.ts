...
/**
 * Redirect info extracted from HTML body by extractJsRedirect.
 */
export interface JsRedirectInfo {
  /** Absolute redirect URL */
  url: string;
  /** True for client-side JS (location.replace, window.location, location.href); false for meta refresh */
...
export class HttpResolver {
   ...
   */
  extractJsRedirect(body: string | undefined, baseUrl: string): JsRedirectInfo | undefined {
