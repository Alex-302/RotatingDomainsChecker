...
import { LogLevel, type Logger } from "./logger.js";
...
class ConnectionDiagnostics {
  private pools = new Map<string, PoolStats>();
  ...
  private updatePoolStats(origin: string, delta: Partial<Record<keyof PoolStats, number>>) {
    ...
    for (const [key, value] of Object.entries(delta)) {
      const k = key as keyof PoolStats;
